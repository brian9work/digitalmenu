...
const Api = {
    ...
    questions:[
        ...
        {question:"¿Cuáles son los costos asociados con sus servicios?",response:"Los costos pueden ser muy variados, dependiendo de lo que usted guste que se agregue en su menu, ya sea servicio a domicilio, ubicacion por gps o solo que se muestre su menu, puede ir desde los $250.00 MXN mensuales."},
        {question:"¿En cuanto tiempo se actualizaria mi informacion en el caso de que quiera cambiar mi menu?",response:"El tiempo dependera del tamaño de la modificacion pero podria tardar desde un par de minutos"},
        {question:"¿Puedo personalizar el diseño de mi página web y menú digital?",response:"Puede personalizar todo lo que usted guste, ademas de tomar asesorias con el equipo de desarrollo para que usted este de acuerdo con el diseño, hasta que usted no este de acuerdo no se empezara a cobrar la mensualidad"},
    ]
}
